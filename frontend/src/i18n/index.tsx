...
const englishMessages: Record<string, string> = {
  ...
  旧版可用: 'Previous version available',
  可使用: 'Available',
  识别失败: 'Recognition failed',
  识别中: 'Recognizing',
  学生作业: 'Student assignment',
  题目上传失败: 'Question upload failed',
  '请到题目库重试': 'Retry from the question library',
  ...
  题目正在识别: 'Question is being recognized',
  'OCR 失败：': 'OCR failed: ',
  ...
  '放弃未上传的文件？': 'Discard files that have not been uploaded?',
  '列表中还有未上传的文件，离开后这些文件不会保留。':
    'There are files not yet uploaded. They will be discarded if you leave.',
  取消: 'Cancel',
  离开: 'Leave',
  ...
  '条批改记录、对话和学生 PDF，无法恢复。请输入题目名称确认：': ' marking records, conversations, and student PDFs. This cannot be undone. Enter the question name to confirm:',
  ...
  '配置的评分标准优先于题目提取结果；留空时由客户端从题目中提取': 'The configured rubric takes priority; when empty, the client extracts one from the question',
